...
import { importLegacySubscriptions } from "./modules/subscriptions/import.js";
...
try { console.log(JSON.stringify(await importLegacySubscriptions(pool, { commit: args.includes("--commit") }))); }
catch {
  console.error("Legacy subscription import failed. No partial import was committed; review purchase import, source/target consistency and migration-role access.");
  process.exitCode = 1;
