...
func (s *Server) mountAgentsRoutes(prefix string, service *api.AgentsService) {
	...
	if connectedDevicesEnabled {
		...
		s.Router.Post(prefix+"/devices/{deviceID}/spaces/{spaceID}/presence", service.DeviceAuthenticated(service.UpdateSpaceConnectedDevicePresence()))
		s.Router.Get(prefix+"/devices/{deviceID}/spaces/{spaceID}/peers", service.DeviceAuthenticated(service.ListSpaceConnectedDevicePeers()))
		s.Router.Post(prefix+"/devices/{deviceID}/spaces/{spaceID}/peer-tickets", service.DeviceAuthenticated(service.IssueSpaceConnectedDeviceTicket()))
